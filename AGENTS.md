...
|-----------|-----------|---------|
| **Framework** | Convex Auth | Built-in to Convex |
| **Features** | OAuth, Email/Password, Magic Links | Extensible providers |
| **Sessions** | Convex tables | Automatic, reactive |
...
**Principle:** Reactive database with built-in realtime sync.

| Data Type | Technology |
|-----------|------------|
| **Relational data** | Convex tables + indexes |
| **Vector search (RAG)** | Convex Vector Search |
| **Sessions** | Convex Auth (built-in) |
| **File storage** | Convex File Storage |
| **Realtime sync** | Automatic via Convex |
...
| `.claude/reference/deployment-best-practices.md` | Docker, Elestio, CI/CD, health checks |
| `.claude/reference/scaling.md` | Stateless patterns, session storage, caching |
| `.claude/reference/cursor-patterns.md` | AI-assisted development guidelines |
| `.claude/reference/document-maintenance.md` | Doc updates, versioning, contributing |
| `convex/README.md` | Convex database setup and patterns |
| `mastra/README.md` | AI agents, tools, workflows |
| `n8n/README.md` | Workflow automation setup |
...
CONVEX_DEPLOY_KEY=...           # For CI/CD deployment
